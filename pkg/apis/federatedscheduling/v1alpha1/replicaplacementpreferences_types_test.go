...
var _ = Describe("ReplicaPlacementPreferences", func() {
	var instance ReplicaPlacementPreferences
	var expected ReplicaPlacementPreferences
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.FederatedschedulingV1alpha1().ReplicaPlacementPreferences("replicaplacementpreferences-test-valid")
