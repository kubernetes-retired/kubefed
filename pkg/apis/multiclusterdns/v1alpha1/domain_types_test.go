...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the Domain resource tests

var _ = Describe("Domain", func() {
	var instance Domain
	var expected Domain
	var client DomainInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.MulticlusterdnsV1alpha1().Domains("default")
