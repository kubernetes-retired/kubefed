...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the DNSEndpoint resource tests

var _ = Describe("DNSEndpoint", func() {
	var instance DNSEndpoint
	var expected DNSEndpoint
	var client DNSEndpointInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.MulticlusterdnsV1alpha1().DNSEndpoints("default")
