...
import (
	...
	. "github.com/kubernetes-sigs/federation-v2/pkg/client/clientset/versioned/typed/scheduling/v1alpha1"
)

// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the JobSchedulingPreference resource tests

var _ = Describe("JobSchedulingPreference", func() {
	var instance JobSchedulingPreference
	var expected JobSchedulingPreference
	var client JobSchedulingPreferenceInterface

	BeforeEach(func() {
		instance = JobSchedulingPreference{}
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.SchedulingV1alpha1().JobSchedulingPreferences("default")
