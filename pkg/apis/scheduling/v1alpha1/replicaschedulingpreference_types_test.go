...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the ReplicaSchedulingPreference resource tests

var _ = Describe("ReplicaSchedulingPreference", func() {
	var instance ReplicaSchedulingPreference
	var expected ReplicaSchedulingPreference
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.SchedulingV1alpha1().ReplicaSchedulingPreferences("default")
