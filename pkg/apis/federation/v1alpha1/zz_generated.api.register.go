...
var (
	...
	federationFederatedSecretOverridesStorage = builders.NewApiResource( // Resource status endpoint
		federation.InternalFederatedSecretOverrides,
		FederatedSecretOverridesSchemeFns{},
		func() runtime.Object { return &FederatedSecretOverrides{} },     // Register versioned resource
		func() runtime.Object { return &FederatedSecretOverridesList{} }, // Register versioned resource list
		&FederatedSecretOverridesStrategy{builders.StorageStrategySingleton},
	)
	ApiVersion = builders.NewApiVersion("federation.k8s.io", "v1alpha1").WithResources(
		...
		), federationFederatedSecretOverridesStorage,
		builders.NewApiResource( // Resource status endpoint
			federation.InternalFederatedSecretOverridesStatus,
			FederatedSecretOverridesSchemeFns{},
			func() runtime.Object { return &FederatedSecretOverrides{} },     // Register versioned resource
			func() runtime.Object { return &FederatedSecretOverridesList{} }, // Register versioned resource list
			&FederatedSecretOverridesStatusStrategy{builders.StatusStorageStrategySingleton},
		))
...
//
// +k8s:deepcopy-gen=false
type FederatedSecretOverridesSchemeFns struct {
	builders.DefaultSchemeFns
}
...
type FederatedSecretOverridesList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []FederatedSecretOverrides `json:"items"`
}
