...
var _ = Describe("FederatedSecretOverrides", func() {
	var instance FederatedSecretOverrides
	var expected FederatedSecretOverrides
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.FederationV1alpha1().FederatedSecretOverrides("federatedsecretoverrides-test-valid")
