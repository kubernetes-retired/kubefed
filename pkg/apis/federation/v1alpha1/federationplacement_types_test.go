...
var _ = Describe("FederationPlacement", func() {
	var instance FederationPlacement
	var expected FederationPlacement
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.FederationV1alpha1().FederationPlacements("federationplacement-test-valid")
