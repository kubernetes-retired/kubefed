...
var _ = Describe("FederatedJobPlacement", func() {
	var instance FederatedJobPlacement
	var expected FederatedJobPlacement
	var client FederatedJobPlacementInterface

	BeforeEach(func() {
		instance = FederatedJobPlacement{}
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.FederationV1alpha1().FederatedJobPlacements("federatedjobplacement-test-valid")
