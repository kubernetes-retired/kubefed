...
var _ = Describe("FederatedJobOverride", func() {
	var instance FederatedJobOverride
	var expected FederatedJobOverride
	var client FederatedJobOverrideInterface

	BeforeEach(func() {
		instance = FederatedJobOverride{}
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.FederationV1alpha1().FederatedJobOverrides("federatedjoboverride-test-valid")
