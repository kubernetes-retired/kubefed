...
var (
	...
	InternalFederatedSecretOverrides = builders.NewInternalResource(
		"federatedsecretoverrides",
		"FederatedSecretOverrides",
		func() runtime.Object { return &FederatedSecretOverrides{} },
		func() runtime.Object { return &FederatedSecretOverridesList{} },
	)
	InternalFederatedSecretOverridesStatus = builders.NewInternalResourceStatus(
		"federatedsecretoverrides",
		"FederatedSecretOverridesStatus",
		func() runtime.Object { return &FederatedSecretOverrides{} },
		func() runtime.Object { return &FederatedSecretOverridesList{} },
	)
	...
	ApiVersion = builders.NewApiGroup("federation.k8s.io").WithKinds(
		...
		InternalFederatedSecretOverrides,
		InternalFederatedSecretOverridesStatus,
	)
...
type FederatedSecretOverrides struct {
	metav1.TypeMeta
	metav1.ObjectMeta
	Spec   FederatedSecretOverridesSpec
	Status FederatedSecretOverridesStatus
}
...
//
// FederatedSecretOverrides Functions and Structs
//
// +k8s:deepcopy-gen=false
type FederatedSecretOverridesStrategy struct {
	builders.DefaultStorageStrategy
}

// +k8s:deepcopy-gen=false
type FederatedSecretOverridesStatusStrategy struct {
	builders.DefaultStatusStorageStrategy
}

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object

type FederatedSecretOverridesList struct {
	metav1.TypeMeta
	metav1.ListMeta
	Items []FederatedSecretOverrides
}

func (FederatedSecretOverrides) NewStatus() interface{} {
	return FederatedSecretOverridesStatus{}
}

func (pc *FederatedSecretOverrides) GetStatus() interface{} {
	return pc.Status
}

func (pc *FederatedSecretOverrides) SetStatus(s interface{}) {
	pc.Status = s.(FederatedSecretOverridesStatus)
}

func (pc *FederatedSecretOverrides) GetSpec() interface{} {
	return pc.Spec
}

func (pc *FederatedSecretOverrides) SetSpec(s interface{}) {
	pc.Spec = s.(FederatedSecretOverridesSpec)
}

func (pc *FederatedSecretOverrides) GetObjectMeta() *metav1.ObjectMeta {
	return &pc.ObjectMeta
}

func (pc *FederatedSecretOverrides) SetGeneration(generation int64) {
	pc.ObjectMeta.Generation = generation
}

func (pc FederatedSecretOverrides) GetGeneration() int64 {
	return pc.ObjectMeta.Generation
}

// Registry is an interface for things that know how to store FederatedSecretOverrides.
// +k8s:deepcopy-gen=false
type FederatedSecretOverridesRegistry interface {
	ListFederatedSecretOverridess(ctx request.Context, options *internalversion.ListOptions) (*FederatedSecretOverridesList, error)
	GetFederatedSecretOverrides(ctx request.Context, id string, options *metav1.GetOptions) (*FederatedSecretOverrides, error)
	CreateFederatedSecretOverrides(ctx request.Context, id *FederatedSecretOverrides) (*FederatedSecretOverrides, error)
	UpdateFederatedSecretOverrides(ctx request.Context, id *FederatedSecretOverrides) (*FederatedSecretOverrides, error)
	DeleteFederatedSecretOverrides(ctx request.Context, id string) (bool, error)
}

// NewRegistry returns a new Registry interface for the given Storage. Any mismatched types will panic.
func NewFederatedSecretOverridesRegistry(sp builders.StandardStorageProvider) FederatedSecretOverridesRegistry {
	return &storageFederatedSecretOverrides{sp}
}

// Implement Registry
// storage puts strong typing around storage calls
// +k8s:deepcopy-gen=false
type storageFederatedSecretOverrides struct {
	builders.StandardStorageProvider
}

func (s *storageFederatedSecretOverrides) ListFederatedSecretOverridess(ctx request.Context, options *internalversion.ListOptions) (*FederatedSecretOverridesList, error) {
	if options != nil && options.FieldSelector != nil && !options.FieldSelector.Empty() {
		return nil, fmt.Errorf("field selector not supported yet")
	}
	st := s.GetStandardStorage()
	...
	return obj.(*FederatedSecretOverridesList), err
}

func (s *storageFederatedSecretOverrides) GetFederatedSecretOverrides(ctx request.Context, id string, options *metav1.GetOptions) (*FederatedSecretOverrides, error) {
	st := s.GetStandardStorage()
	obj, err := st.Get(ctx, id, options)
	if err != nil {
		return nil, err
	}
	return obj.(*FederatedSecretOverrides), nil
}

func (s *storageFederatedSecretOverrides) CreateFederatedSecretOverrides(ctx request.Context, object *FederatedSecretOverrides) (*FederatedSecretOverrides, error) {
	st := s.GetStandardStorage()
	obj, err := st.Create(ctx, object, nil, true)
	if err != nil {
		return nil, err
...
func (s *storageFederatedSecretOverrides) UpdateFederatedSecretOverrides(ctx request.Context, object *FederatedSecretOverrides) (*FederatedSecretOverrides, error) {
	st := s.GetStandardStorage()
	obj, _, err := st.Update(ctx, object.Name, rest.DefaultUpdatedObjectInfo(object), nil, nil)
	if err != nil {
		return nil, err
...
func (s *storageFederatedSecretOverrides) DeleteFederatedSecretOverrides(ctx request.Context, id string) (bool, error) {
	st := s.GetStandardStorage()
	_, sync, err := st.Delete(ctx, id, nil)
	return sync, err
}
