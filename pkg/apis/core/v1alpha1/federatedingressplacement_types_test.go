...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the FederatedIngressPlacement resource tests

var _ = Describe("FederatedIngressPlacement", func() {
	var instance FederatedIngressPlacement
	var expected FederatedIngressPlacement
	var client FederatedIngressPlacementInterface

	BeforeEach(func() {
		instance = FederatedIngressPlacement{}
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.CoreV1alpha1().FederatedIngressPlacements("default")
