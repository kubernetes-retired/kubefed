...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the FederatedServiceAccountPlacement resource tests

var _ = Describe("FederatedServiceAccountPlacement", func() {
	var instance FederatedServiceAccountPlacement
	var expected FederatedServiceAccountPlacement
	var client FederatedServiceAccountPlacementInterface

	BeforeEach(func() {
		instance = FederatedServiceAccountPlacement{}
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.CoreV1alpha1().FederatedServiceAccountPlacements("default")
