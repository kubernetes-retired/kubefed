...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FederatedDeploymentClusterStatus) DeepCopyInto(out *FederatedDeploymentClusterStatus) {
	*out = *in
	in.Status.DeepCopyInto(&out.Status)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FederatedDeploymentClusterStatus.
func (in *FederatedDeploymentClusterStatus) DeepCopy() *FederatedDeploymentClusterStatus {
	if in == nil {
		return nil
	}
	out := new(FederatedDeploymentClusterStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FederatedDeploymentStatus) DeepCopyInto(out *FederatedDeploymentStatus) {
	*out = *in
	if in.ClusterStatuses != nil {
		...
		*out = make([]FederatedDeploymentClusterStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FederatedIngressClusterStatus) DeepCopyInto(out *FederatedIngressClusterStatus) {
	*out = *in
	in.Status.DeepCopyInto(&out.Status)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FederatedIngressClusterStatus.
func (in *FederatedIngressClusterStatus) DeepCopy() *FederatedIngressClusterStatus {
	if in == nil {
		return nil
	}
	out := new(FederatedIngressClusterStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FederatedIngressStatus) DeepCopyInto(out *FederatedIngressStatus) {
	*out = *in
	if in.ClusterStatuses != nil {
		in, out := &in.ClusterStatuses, &out.ClusterStatuses
		*out = make([]FederatedIngressClusterStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FederatedJobClusterStatus) DeepCopyInto(out *FederatedJobClusterStatus) {
	*out = *in
	in.Status.DeepCopyInto(&out.Status)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FederatedJobClusterStatus.
func (in *FederatedJobClusterStatus) DeepCopy() *FederatedJobClusterStatus {
	if in == nil {
		return nil
	}
	out := new(FederatedJobClusterStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FederatedJobStatus) DeepCopyInto(out *FederatedJobStatus) {
	*out = *in
	if in.ClusterStatuses != nil {
		in, out := &in.ClusterStatuses, &out.ClusterStatuses
		*out = make([]FederatedJobClusterStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FederatedReplicaSetClusterStatus) DeepCopyInto(out *FederatedReplicaSetClusterStatus) {
	*out = *in
	in.Status.DeepCopyInto(&out.Status)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FederatedReplicaSetClusterStatus.
func (in *FederatedReplicaSetClusterStatus) DeepCopy() *FederatedReplicaSetClusterStatus {
	if in == nil {
		return nil
	}
	out := new(FederatedReplicaSetClusterStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FederatedReplicaSetStatus) DeepCopyInto(out *FederatedReplicaSetStatus) {
	*out = *in
	if in.ClusterStatuses != nil {
		in, out := &in.ClusterStatuses, &out.ClusterStatuses
		*out = make([]FederatedReplicaSetClusterStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
