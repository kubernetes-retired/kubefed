...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the FederatedServiceAccount resource tests

var _ = Describe("FederatedServiceAccount", func() {
	var instance FederatedServiceAccount
	var expected FederatedServiceAccount
	var client FederatedServiceAccountInterface

	BeforeEach(func() {
		instance = FederatedServiceAccount{}
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.CoreV1alpha1().FederatedServiceAccounts("default")
