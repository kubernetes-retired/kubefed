...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the FederatedIngress resource tests

var _ = Describe("FederatedIngress", func() {
	var instance FederatedIngress
	var expected FederatedIngress
	var client FederatedIngressInterface

	BeforeEach(func() {
		instance = FederatedIngress{}
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.CoreV1alpha1().FederatedIngresses("default")
