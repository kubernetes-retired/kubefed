...
var _ = Describe("FederatedDeploymentPlacement controller", func() {
	var instance FederatedDeploymentPlacement
	var expectedKey string
	var client FederatedDeploymentPlacementInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = FederatedDeploymentPlacement{}
		instance.Name = "instance-1"
		expectedKey = "federateddeploymentplacement-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederatedDeploymentPlacements("federateddeploymentplacement-controller-test-handler")
