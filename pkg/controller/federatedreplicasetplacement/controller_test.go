...
package federatedreplicasetplacement_test
...
var _ = Describe("FederatedReplicaSetPlacement controller", func() {
	...
	BeforeEach(func() {
		...
		expectedKey = "federatedreplicasetplacement-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederatedReplicaSetPlacements("federatedreplicasetplacement-controller-test-handler")
