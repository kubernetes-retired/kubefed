...
var controller *federatedreplicasetoverride.FederatedReplicaSetOverrideController
var si *sharedinformers.SharedInformers

func TestFederatedReplicaSetOverride(t *testing.T) {
...
var _ = BeforeSuite(func() {
	...
	controller = federatedreplicasetoverride.NewFederatedReplicaSetOverrideController(config, si)
