...
var _ = Describe("FederatedReplicaSetOverride controller", func() {
	...
	BeforeEach(func() {
		...
		expectedKey = "federatedreplicasetoverride-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederatedReplicaSetOverrides("federatedreplicasetoverride-controller-test-handler")
