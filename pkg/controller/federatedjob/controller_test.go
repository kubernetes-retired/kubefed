...
var _ = Describe("FederatedJob controller", func() {
	var instance FederatedJob
	var expectedKey string
	var client FederatedJobInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = FederatedJob{}
		instance.Name = "instance-1"
		expectedKey = "federatedjob-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederatedJobs("federatedjob-controller-test-handler")
