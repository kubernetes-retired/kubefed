...
package federationplacement_test
...
var _ = Describe("FederationPlacement controller", func() {
	var instance FederationPlacement
	var expectedKey string
	var client FederationPlacementInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = FederationPlacement{}
		instance.Name = "instance-1"
		expectedKey = "federationplacement-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederationPlacements("federationplacement-controller-test-handler")
