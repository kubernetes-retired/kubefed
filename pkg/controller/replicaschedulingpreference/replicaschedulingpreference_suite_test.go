...
var controller *replicaschedulingpreference.ReplicaSchedulingPreferenceController
var si *sharedinformers.SharedInformers

func TestReplicaSchedulingPreference(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecsWithDefaultAndCustomReporters(t, "ReplicaSchedulingPreference Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	controller = replicaschedulingpreference.NewReplicaSchedulingPreferenceController(config, si)
