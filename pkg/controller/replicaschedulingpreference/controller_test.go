...
package replicaschedulingpreference_test

import (
	"time"

	. "github.com/kubernetes-sigs/federation-v2/pkg/apis/federatedscheduling/v1alpha1"
	. "github.com/kubernetes-sigs/federation-v2/pkg/client/clientset_generated/clientset/typed/federatedscheduling/v1alpha1"
...
var _ = Describe("ReplicaSchedulingPreference controller", func() {
	var instance ReplicaSchedulingPreference
	...
	BeforeEach(func() {
		...
		expectedKey = "replicaschedulingpreference-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederatedschedulingV1alpha1().ReplicaSchedulingPreferences("replicaschedulingpreference-controller-test-handler")
