...
var _ = Describe("FederatedSecret controller", func() {
	var instance FederatedSecret
	var expectedKey string
	var client FederatedSecretInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = FederatedSecret{}
		instance.Name = "instance-1"
		expectedKey = "federatedsecret-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederatedSecrets("federatedsecret-controller-test-handler")
