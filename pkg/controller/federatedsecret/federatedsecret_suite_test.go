...
var controller *federatedsecret.FederatedSecretController
var si *sharedinformers.SharedInformers

func TestFederatedSecret(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecsWithDefaultAndCustomReporters(t, "FederatedSecret Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	controller = federatedsecret.NewFederatedSecretController(config, si)
