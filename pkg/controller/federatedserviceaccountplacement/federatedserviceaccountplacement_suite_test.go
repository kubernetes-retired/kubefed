...
package federatedserviceaccountplacement_test
...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "FederatedServiceAccountPlacement Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	Eventually(func() interface{} {
		return arguments.ControllerManager.GetController("FederatedServiceAccountPlacementController")
	}).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("FederatedServiceAccountPlacementController")
})
