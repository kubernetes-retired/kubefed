...
package propagatedversion_test
...
var _ = Describe("PropagatedVersion controller", func() {
	var instance PropagatedVersion
	var expectedKey string
	var client PropagatedVersionInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = PropagatedVersion{}
		instance.Name = "instance-1"
		expectedKey = "propagatedversion-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().PropagatedVersions("propagatedversion-controller-test-handler")
