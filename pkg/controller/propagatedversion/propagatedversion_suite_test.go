...
var controller *propagatedversion.PropagatedVersionController
var si *sharedinformers.SharedInformers

func TestPropagatedVersion(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecsWithDefaultAndCustomReporters(t, "PropagatedVersion Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	controller = propagatedversion.NewPropagatedVersionController(config, si)
