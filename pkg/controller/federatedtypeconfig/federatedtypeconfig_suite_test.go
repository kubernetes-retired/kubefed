...
var controller *federatedtypeconfig.FederatedTypeConfigController
var si *sharedinformers.SharedInformers

func TestFederatedTypeConfig(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecsWithDefaultAndCustomReporters(t, "FederatedTypeConfig Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	controller = federatedtypeconfig.NewFederatedTypeConfigController(config, si)
