...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "FederatedIngress Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("FederatedIngressController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("FederatedIngressController")
})
