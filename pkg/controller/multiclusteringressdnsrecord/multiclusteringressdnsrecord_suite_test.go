...
package multiclusteringressdnsrecord_test
...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "MultiClusterIngressDNSRecord Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	Eventually(func() interface{} {
		return arguments.ControllerManager.GetController("MultiClusterIngressDNSRecordController")
	}).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("MultiClusterIngressDNSRecordController")
})
