...
var _ = Describe("FederatedNamespace controller", func() {
	var instance FederatedNamespace
	var expectedKey string
	var client FederatedNamespaceInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = FederatedNamespace{}
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederatedNamespaces()
