...
package federatedsecretoverride_test
...
var _ = Describe("FederatedSecretOverride controller", func() {
	var instance FederatedSecretOverride
	var expectedKey string
	var client FederatedSecretOverrideInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = FederatedSecretOverride{}
		instance.Name = "instance-1"
		expectedKey = "federatedsecretoverride-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederatedSecretOverrides("federatedsecretoverride-controller-test-handler")
