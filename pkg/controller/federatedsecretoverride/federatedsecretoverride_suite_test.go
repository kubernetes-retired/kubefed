...
var controller *federatedsecretoverride.FederatedSecretOverrideController
var si *sharedinformers.SharedInformers

func TestFederatedSecretOverride(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecsWithDefaultAndCustomReporters(t, "FederatedSecretOverride Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	controller = federatedsecretoverride.NewFederatedSecretOverrideController(config, si)
