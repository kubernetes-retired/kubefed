...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "DNSEndpoint Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("DNSEndpointController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("DNSEndpointController")
})
