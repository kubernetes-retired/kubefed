...
package federatedconfigmap_test
...
var _ = Describe("FederatedConfigMap controller", func() {
	var instance FederatedConfigMap
	var expectedKey string
	var client FederatedConfigMapInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = FederatedConfigMap{}
		instance.Name = "instance-1"
		expectedKey = "federatedconfigmap-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederatedConfigMaps("federatedconfigmap-controller-test-handler")
