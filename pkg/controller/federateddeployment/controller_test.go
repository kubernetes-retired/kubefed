...
var _ = Describe("FederatedDeployment controller", func() {
	...
	BeforeEach(func() {
		...
		expectedKey = "federateddeployment-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederatedDeployments("federateddeployment-controller-test-handler")
