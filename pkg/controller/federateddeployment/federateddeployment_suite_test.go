...
var controller *federateddeployment.FederatedDeploymentController
var si *sharedinformers.SharedInformers

func TestFederatedDeployment(t *testing.T) {
...
var _ = BeforeSuite(func() {
	...
	controller = federateddeployment.NewFederatedDeploymentController(config, si)
