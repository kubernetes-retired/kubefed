...
var _ = Describe("FederatedService controller", func() {
	var instance FederatedService
	var expectedKey string
	var client FederatedServiceInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = FederatedService{}
		instance.Name = "instance-1"
		expectedKey = "federatedservice-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederatedServices("federatedservice-controller-test-handler")
