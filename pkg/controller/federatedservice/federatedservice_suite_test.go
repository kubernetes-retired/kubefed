...
var controller *federatedservice.FederatedServiceController
var si *sharedinformers.SharedInformers

func TestFederatedService(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecsWithDefaultAndCustomReporters(t, "FederatedService Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	controller = federatedservice.NewFederatedServiceController(config, si)
