...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "JobSchedulingPreference Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	Eventually(func() interface{} {
		return arguments.ControllerManager.GetController("JobSchedulingPreferenceController")
	}).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("JobSchedulingPreferenceController")
})
