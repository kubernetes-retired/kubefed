...
var _ = Describe("FederatedServicePlacement controller", func() {
	var instance FederatedServicePlacement
	var expectedKey string
	var client FederatedServicePlacementInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = FederatedServicePlacement{}
		instance.Name = "instance-1"
		expectedKey = "federatedserviceplacement-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederatedServicePlacements("federatedserviceplacement-controller-test-handler")
