...
package federatednamespaceplacement_test
...
var _ = Describe("FederatedNamespacePlacement controller", func() {
	var instance FederatedNamespacePlacement
	var expectedKey string
	var client FederatedNamespacePlacementInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = FederatedNamespacePlacement{}
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederatedNamespacePlacements()
