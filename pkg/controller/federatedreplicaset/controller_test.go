...
package federatedreplicaset_test
...
var _ = Describe("FederatedReplicaSet controller", func() {
	var instance FederatedReplicaSet
	var expectedKey string
	var client FederatedReplicaSetInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = FederatedReplicaSet{}
		instance.Name = "instance-1"
		expectedKey = "federatedreplicaset-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.FederationV1alpha1().FederatedReplicaSets("federatedreplicaset-controller-test-handler")
