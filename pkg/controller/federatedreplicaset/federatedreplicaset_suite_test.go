...
var controller *federatedreplicaset.FederatedReplicaSetController
var si *sharedinformers.SharedInformers

func TestFederatedReplicaSet(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecsWithDefaultAndCustomReporters(t, "FederatedReplicaSet Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	controller = federatedreplicaset.NewFederatedReplicaSetController(config, si)
