...
type FederatedResource struct {
	...
	Spec   FederatedResourceSpec   `json:"spec,omitempty"`
	Status FederatedResourceStatus `json:"status,omitempty"`
}

// FederatedResourceStatus defines spec of generic federated type
type FederatedResourceSpec struct {
}
...
type FederatedResourceStatus struct {
	ClusterStatuses []ResourceClusterStatus `json:"clusterStatuses,omitempty"`
}
