...
var _ = Describe("MultiClusterServiceDNSRecord controller", func() {
	...
	BeforeEach(func() {
		...
		expectedKey = "multiclusterservicednsrecord-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.MulticlusterdnsV1alpha1().MultiClusterServiceDNSRecords("multiclusterservicednsrecord-controller-test-handler")
