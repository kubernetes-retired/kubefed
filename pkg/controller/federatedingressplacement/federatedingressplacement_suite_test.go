...
package federatedingressplacement_test
...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "FederatedIngressPlacement Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	Eventually(func() interface{} {
		return arguments.ControllerManager.GetController("FederatedIngressPlacementController")
	}).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("FederatedIngressPlacementController")
})
