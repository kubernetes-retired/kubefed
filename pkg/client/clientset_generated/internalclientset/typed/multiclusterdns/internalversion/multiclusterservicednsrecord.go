...
type MultiClusterServiceDNSRecordInterface interface {
	Create(*multiclusterdns.MultiClusterServiceDNSRecord) (*multiclusterdns.MultiClusterServiceDNSRecord, error)
	Update(*multiclusterdns.MultiClusterServiceDNSRecord) (*multiclusterdns.MultiClusterServiceDNSRecord, error)
	UpdateStatus(*multiclusterdns.MultiClusterServiceDNSRecord) (*multiclusterdns.MultiClusterServiceDNSRecord, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*multiclusterdns.MultiClusterServiceDNSRecord, error)
	List(opts v1.ListOptions) (*multiclusterdns.MultiClusterServiceDNSRecordList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *multiclusterdns.MultiClusterServiceDNSRecord, err error)
...
func newMultiClusterServiceDNSRecords(c *MulticlusterdnsClient, namespace string) *multiClusterServiceDNSRecords {
...
func (c *multiClusterServiceDNSRecords) Get(name string, options v1.GetOptions) (result *multiclusterdns.MultiClusterServiceDNSRecord, err error) {
	result = &multiclusterdns.MultiClusterServiceDNSRecord{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *multiClusterServiceDNSRecords) List(opts v1.ListOptions) (result *multiclusterdns.MultiClusterServiceDNSRecordList, err error) {
	result = &multiclusterdns.MultiClusterServiceDNSRecordList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("multiclusterservicednsrecords").
...
func (c *multiClusterServiceDNSRecords) Create(multiClusterServiceDNSRecord *multiclusterdns.MultiClusterServiceDNSRecord) (result *multiclusterdns.MultiClusterServiceDNSRecord, err error) {
	result = &multiclusterdns.MultiClusterServiceDNSRecord{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("multiclusterservicednsrecords").
...
func (c *multiClusterServiceDNSRecords) Update(multiClusterServiceDNSRecord *multiclusterdns.MultiClusterServiceDNSRecord) (result *multiclusterdns.MultiClusterServiceDNSRecord, err error) {
	result = &multiclusterdns.MultiClusterServiceDNSRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("multiclusterservicednsrecords").
...
func (c *multiClusterServiceDNSRecords) UpdateStatus(multiClusterServiceDNSRecord *multiclusterdns.MultiClusterServiceDNSRecord) (result *multiclusterdns.MultiClusterServiceDNSRecord, err error) {
	result = &multiclusterdns.MultiClusterServiceDNSRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("multiclusterservicednsrecords").
...
func (c *multiClusterServiceDNSRecords) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *multiclusterdns.MultiClusterServiceDNSRecord, err error) {
	result = &multiclusterdns.MultiClusterServiceDNSRecord{}
