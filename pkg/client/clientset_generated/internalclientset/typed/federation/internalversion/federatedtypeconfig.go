...
type FederatedTypeConfigInterface interface {
	Create(*federation.FederatedTypeConfig) (*federation.FederatedTypeConfig, error)
	Update(*federation.FederatedTypeConfig) (*federation.FederatedTypeConfig, error)
	UpdateStatus(*federation.FederatedTypeConfig) (*federation.FederatedTypeConfig, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*federation.FederatedTypeConfig, error)
	List(opts v1.ListOptions) (*federation.FederatedTypeConfigList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *federation.FederatedTypeConfig, err error)
...
func newFederatedTypeConfigs(c *FederationClient) *federatedTypeConfigs {
...
func (c *federatedTypeConfigs) Get(name string, options v1.GetOptions) (result *federation.FederatedTypeConfig, err error) {
	result = &federation.FederatedTypeConfig{}
	err = c.client.Get().
...
func (c *federatedTypeConfigs) List(opts v1.ListOptions) (result *federation.FederatedTypeConfigList, err error) {
	result = &federation.FederatedTypeConfigList{}
	err = c.client.Get().
		Resource("federatedtypeconfigs").
...
func (c *federatedTypeConfigs) Create(federatedTypeConfig *federation.FederatedTypeConfig) (result *federation.FederatedTypeConfig, err error) {
	result = &federation.FederatedTypeConfig{}
	err = c.client.Post().
		Resource("federatedtypeconfigs").
...
func (c *federatedTypeConfigs) Update(federatedTypeConfig *federation.FederatedTypeConfig) (result *federation.FederatedTypeConfig, err error) {
	result = &federation.FederatedTypeConfig{}
	err = c.client.Put().
		Resource("federatedtypeconfigs").
...
func (c *federatedTypeConfigs) UpdateStatus(federatedTypeConfig *federation.FederatedTypeConfig) (result *federation.FederatedTypeConfig, err error) {
	result = &federation.FederatedTypeConfig{}
	err = c.client.Put().
		Resource("federatedtypeconfigs").
		Name(federatedTypeConfig.Name).
...
func (c *federatedTypeConfigs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *federation.FederatedTypeConfig, err error) {
	result = &federation.FederatedTypeConfig{}
