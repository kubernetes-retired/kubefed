...
type FederatedDeploymentPlacementInterface interface {
	Create(*federation.FederatedDeploymentPlacement) (*federation.FederatedDeploymentPlacement, error)
	Update(*federation.FederatedDeploymentPlacement) (*federation.FederatedDeploymentPlacement, error)
	UpdateStatus(*federation.FederatedDeploymentPlacement) (*federation.FederatedDeploymentPlacement, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*federation.FederatedDeploymentPlacement, error)
	List(opts v1.ListOptions) (*federation.FederatedDeploymentPlacementList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *federation.FederatedDeploymentPlacement, err error)
...
func newFederatedDeploymentPlacements(c *FederationClient, namespace string) *federatedDeploymentPlacements {
...
func (c *federatedDeploymentPlacements) Get(name string, options v1.GetOptions) (result *federation.FederatedDeploymentPlacement, err error) {
	result = &federation.FederatedDeploymentPlacement{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *federatedDeploymentPlacements) List(opts v1.ListOptions) (result *federation.FederatedDeploymentPlacementList, err error) {
	result = &federation.FederatedDeploymentPlacementList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("federateddeploymentplacements").
...
func (c *federatedDeploymentPlacements) Create(federatedDeploymentPlacement *federation.FederatedDeploymentPlacement) (result *federation.FederatedDeploymentPlacement, err error) {
	result = &federation.FederatedDeploymentPlacement{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("federateddeploymentplacements").
...
func (c *federatedDeploymentPlacements) Update(federatedDeploymentPlacement *federation.FederatedDeploymentPlacement) (result *federation.FederatedDeploymentPlacement, err error) {
	result = &federation.FederatedDeploymentPlacement{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federateddeploymentplacements").
...
func (c *federatedDeploymentPlacements) UpdateStatus(federatedDeploymentPlacement *federation.FederatedDeploymentPlacement) (result *federation.FederatedDeploymentPlacement, err error) {
	result = &federation.FederatedDeploymentPlacement{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federateddeploymentplacements").
...
func (c *federatedDeploymentPlacements) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *federation.FederatedDeploymentPlacement, err error) {
	result = &federation.FederatedDeploymentPlacement{}
