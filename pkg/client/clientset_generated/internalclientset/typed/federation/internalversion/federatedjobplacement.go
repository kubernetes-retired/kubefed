...
type FederatedJobPlacementInterface interface {
	Create(*federation.FederatedJobPlacement) (*federation.FederatedJobPlacement, error)
	Update(*federation.FederatedJobPlacement) (*federation.FederatedJobPlacement, error)
	UpdateStatus(*federation.FederatedJobPlacement) (*federation.FederatedJobPlacement, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*federation.FederatedJobPlacement, error)
	List(opts v1.ListOptions) (*federation.FederatedJobPlacementList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *federation.FederatedJobPlacement, err error)
...
func newFederatedJobPlacements(c *FederationClient, namespace string) *federatedJobPlacements {
...
func (c *federatedJobPlacements) Get(name string, options v1.GetOptions) (result *federation.FederatedJobPlacement, err error) {
	result = &federation.FederatedJobPlacement{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *federatedJobPlacements) List(opts v1.ListOptions) (result *federation.FederatedJobPlacementList, err error) {
	result = &federation.FederatedJobPlacementList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("federatedjobplacements").
...
func (c *federatedJobPlacements) Create(federatedJobPlacement *federation.FederatedJobPlacement) (result *federation.FederatedJobPlacement, err error) {
	result = &federation.FederatedJobPlacement{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("federatedjobplacements").
...
func (c *federatedJobPlacements) Update(federatedJobPlacement *federation.FederatedJobPlacement) (result *federation.FederatedJobPlacement, err error) {
	result = &federation.FederatedJobPlacement{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedjobplacements").
...
func (c *federatedJobPlacements) UpdateStatus(federatedJobPlacement *federation.FederatedJobPlacement) (result *federation.FederatedJobPlacement, err error) {
	result = &federation.FederatedJobPlacement{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedjobplacements").
...
func (c *federatedJobPlacements) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *federation.FederatedJobPlacement, err error) {
	result = &federation.FederatedJobPlacement{}
