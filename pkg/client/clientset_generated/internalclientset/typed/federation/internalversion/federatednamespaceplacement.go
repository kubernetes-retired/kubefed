...
type FederatedNamespacePlacementInterface interface {
	Create(*federation.FederatedNamespacePlacement) (*federation.FederatedNamespacePlacement, error)
	Update(*federation.FederatedNamespacePlacement) (*federation.FederatedNamespacePlacement, error)
	UpdateStatus(*federation.FederatedNamespacePlacement) (*federation.FederatedNamespacePlacement, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*federation.FederatedNamespacePlacement, error)
	List(opts v1.ListOptions) (*federation.FederatedNamespacePlacementList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *federation.FederatedNamespacePlacement, err error)
...
func newFederatedNamespacePlacements(c *FederationClient) *federatedNamespacePlacements {
...
func (c *federatedNamespacePlacements) Get(name string, options v1.GetOptions) (result *federation.FederatedNamespacePlacement, err error) {
	result = &federation.FederatedNamespacePlacement{}
	err = c.client.Get().
...
func (c *federatedNamespacePlacements) List(opts v1.ListOptions) (result *federation.FederatedNamespacePlacementList, err error) {
	result = &federation.FederatedNamespacePlacementList{}
	err = c.client.Get().
		Resource("federatednamespaceplacements").
...
func (c *federatedNamespacePlacements) Create(federatedNamespacePlacement *federation.FederatedNamespacePlacement) (result *federation.FederatedNamespacePlacement, err error) {
	result = &federation.FederatedNamespacePlacement{}
	err = c.client.Post().
		Resource("federatednamespaceplacements").
...
func (c *federatedNamespacePlacements) Update(federatedNamespacePlacement *federation.FederatedNamespacePlacement) (result *federation.FederatedNamespacePlacement, err error) {
	result = &federation.FederatedNamespacePlacement{}
	err = c.client.Put().
		Resource("federatednamespaceplacements").
...
func (c *federatedNamespacePlacements) UpdateStatus(federatedNamespacePlacement *federation.FederatedNamespacePlacement) (result *federation.FederatedNamespacePlacement, err error) {
	result = &federation.FederatedNamespacePlacement{}
	err = c.client.Put().
		Resource("federatednamespaceplacements").
		Name(federatedNamespacePlacement.Name).
...
func (c *federatedNamespacePlacements) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *federation.FederatedNamespacePlacement, err error) {
	result = &federation.FederatedNamespacePlacement{}
