...
import (
	...
	scheme "github.com/marun/federation-v2/pkg/client/clientset_generated/clientset/scheme"
...
type FederatedReplicaSetPlacementInterface interface {
	Create(*v1alpha1.FederatedReplicaSetPlacement) (*v1alpha1.FederatedReplicaSetPlacement, error)
	Update(*v1alpha1.FederatedReplicaSetPlacement) (*v1alpha1.FederatedReplicaSetPlacement, error)
	UpdateStatus(*v1alpha1.FederatedReplicaSetPlacement) (*v1alpha1.FederatedReplicaSetPlacement, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.FederatedReplicaSetPlacement, error)
	List(opts v1.ListOptions) (*v1alpha1.FederatedReplicaSetPlacementList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.FederatedReplicaSetPlacement, err error)
...
func newFederatedReplicaSetPlacements(c *FederationV1alpha1Client, namespace string) *federatedReplicaSetPlacements {
...
func (c *federatedReplicaSetPlacements) Get(name string, options v1.GetOptions) (result *v1alpha1.FederatedReplicaSetPlacement, err error) {
	result = &v1alpha1.FederatedReplicaSetPlacement{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *federatedReplicaSetPlacements) List(opts v1.ListOptions) (result *v1alpha1.FederatedReplicaSetPlacementList, err error) {
	result = &v1alpha1.FederatedReplicaSetPlacementList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("federatedreplicasetplacements").
...
func (c *federatedReplicaSetPlacements) Create(federatedReplicaSetPlacement *v1alpha1.FederatedReplicaSetPlacement) (result *v1alpha1.FederatedReplicaSetPlacement, err error) {
	result = &v1alpha1.FederatedReplicaSetPlacement{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("federatedreplicasetplacements").
...
func (c *federatedReplicaSetPlacements) Update(federatedReplicaSetPlacement *v1alpha1.FederatedReplicaSetPlacement) (result *v1alpha1.FederatedReplicaSetPlacement, err error) {
	result = &v1alpha1.FederatedReplicaSetPlacement{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedreplicasetplacements").
...
func (c *federatedReplicaSetPlacements) UpdateStatus(federatedReplicaSetPlacement *v1alpha1.FederatedReplicaSetPlacement) (result *v1alpha1.FederatedReplicaSetPlacement, err error) {
	result = &v1alpha1.FederatedReplicaSetPlacement{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedreplicasetplacements").
...
func (c *federatedReplicaSetPlacements) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.FederatedReplicaSetPlacement, err error) {
	result = &v1alpha1.FederatedReplicaSetPlacement{}
