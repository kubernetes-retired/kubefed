...
type FederatedConfigMapOverrideInterface interface {
	Create(*v1alpha1.FederatedConfigMapOverride) (*v1alpha1.FederatedConfigMapOverride, error)
	Update(*v1alpha1.FederatedConfigMapOverride) (*v1alpha1.FederatedConfigMapOverride, error)
	UpdateStatus(*v1alpha1.FederatedConfigMapOverride) (*v1alpha1.FederatedConfigMapOverride, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.FederatedConfigMapOverride, error)
	List(opts v1.ListOptions) (*v1alpha1.FederatedConfigMapOverrideList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.FederatedConfigMapOverride, err error)
...
func newFederatedConfigMapOverrides(c *FederationV1alpha1Client, namespace string) *federatedConfigMapOverrides {
...
func (c *federatedConfigMapOverrides) Get(name string, options v1.GetOptions) (result *v1alpha1.FederatedConfigMapOverride, err error) {
	result = &v1alpha1.FederatedConfigMapOverride{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *federatedConfigMapOverrides) List(opts v1.ListOptions) (result *v1alpha1.FederatedConfigMapOverrideList, err error) {
	result = &v1alpha1.FederatedConfigMapOverrideList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("federatedconfigmapoverrides").
...
func (c *federatedConfigMapOverrides) Create(federatedConfigMapOverride *v1alpha1.FederatedConfigMapOverride) (result *v1alpha1.FederatedConfigMapOverride, err error) {
	result = &v1alpha1.FederatedConfigMapOverride{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("federatedconfigmapoverrides").
...
func (c *federatedConfigMapOverrides) Update(federatedConfigMapOverride *v1alpha1.FederatedConfigMapOverride) (result *v1alpha1.FederatedConfigMapOverride, err error) {
	result = &v1alpha1.FederatedConfigMapOverride{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedconfigmapoverrides").
...
func (c *federatedConfigMapOverrides) UpdateStatus(federatedConfigMapOverride *v1alpha1.FederatedConfigMapOverride) (result *v1alpha1.FederatedConfigMapOverride, err error) {
	result = &v1alpha1.FederatedConfigMapOverride{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedconfigmapoverrides").
...
func (c *federatedConfigMapOverrides) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.FederatedConfigMapOverride, err error) {
	result = &v1alpha1.FederatedConfigMapOverride{}
