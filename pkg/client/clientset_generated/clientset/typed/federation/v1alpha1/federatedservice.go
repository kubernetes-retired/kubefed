...
func newFederatedServices(c *FederationV1alpha1Client, namespace string) *federatedServices {
...
func (c *federatedServices) Get(name string, options v1.GetOptions) (result *v1alpha1.FederatedService, err error) {
...
func (c *federatedServices) List(opts v1.ListOptions) (result *v1alpha1.FederatedServiceList, err error) {
	result = &v1alpha1.FederatedServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("federatedservices").
...
func (c *federatedServices) Create(federatedService *v1alpha1.FederatedService) (result *v1alpha1.FederatedService, err error) {
	result = &v1alpha1.FederatedService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("federatedservices").
...
func (c *federatedServices) Update(federatedService *v1alpha1.FederatedService) (result *v1alpha1.FederatedService, err error) {
	result = &v1alpha1.FederatedService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedservices").
...
func (c *federatedServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.FederatedService, err error) {
	result = &v1alpha1.FederatedService{}
