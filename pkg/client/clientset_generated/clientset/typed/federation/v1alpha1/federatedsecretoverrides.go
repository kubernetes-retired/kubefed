...
type FederatedSecretOverridesInterface interface {
	Create(*v1alpha1.FederatedSecretOverrides) (*v1alpha1.FederatedSecretOverrides, error)
	Update(*v1alpha1.FederatedSecretOverrides) (*v1alpha1.FederatedSecretOverrides, error)
	UpdateStatus(*v1alpha1.FederatedSecretOverrides) (*v1alpha1.FederatedSecretOverrides, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.FederatedSecretOverrides, error)
	List(opts v1.ListOptions) (*v1alpha1.FederatedSecretOverridesList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.FederatedSecretOverrides, err error)
...
func newFederatedSecretOverrideses(c *FederationV1alpha1Client, namespace string) *federatedSecretOverrideses {
...
func (c *federatedSecretOverrideses) Get(name string, options v1.GetOptions) (result *v1alpha1.FederatedSecretOverrides, err error) {
	result = &v1alpha1.FederatedSecretOverrides{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *federatedSecretOverrideses) List(opts v1.ListOptions) (result *v1alpha1.FederatedSecretOverridesList, err error) {
	result = &v1alpha1.FederatedSecretOverridesList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("federatedsecretoverrideses").
...
func (c *federatedSecretOverrideses) Create(federatedSecretOverrides *v1alpha1.FederatedSecretOverrides) (result *v1alpha1.FederatedSecretOverrides, err error) {
	result = &v1alpha1.FederatedSecretOverrides{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("federatedsecretoverrideses").
...
func (c *federatedSecretOverrideses) Update(federatedSecretOverrides *v1alpha1.FederatedSecretOverrides) (result *v1alpha1.FederatedSecretOverrides, err error) {
	result = &v1alpha1.FederatedSecretOverrides{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedsecretoverrideses").
...
func (c *federatedSecretOverrideses) UpdateStatus(federatedSecretOverrides *v1alpha1.FederatedSecretOverrides) (result *v1alpha1.FederatedSecretOverrides, err error) {
	result = &v1alpha1.FederatedSecretOverrides{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedsecretoverrideses").
...
func (c *federatedSecretOverrideses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.FederatedSecretOverrides, err error) {
	result = &v1alpha1.FederatedSecretOverrides{}
