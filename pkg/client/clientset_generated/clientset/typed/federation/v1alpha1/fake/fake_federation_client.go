...
func (c *FakeFederationV1alpha1) FederatedSecretOverrideses(namespace string) v1alpha1.FederatedSecretOverridesInterface {
	return &FakeFederatedSecretOverrideses{c, namespace}
}
