...
type FederatedNamespaceInterface interface {
	Create(*v1alpha1.FederatedNamespace) (*v1alpha1.FederatedNamespace, error)
	Update(*v1alpha1.FederatedNamespace) (*v1alpha1.FederatedNamespace, error)
	UpdateStatus(*v1alpha1.FederatedNamespace) (*v1alpha1.FederatedNamespace, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.FederatedNamespace, error)
	List(opts v1.ListOptions) (*v1alpha1.FederatedNamespaceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.FederatedNamespace, err error)
...
func newFederatedNamespaces(c *FederationV1alpha1Client) *federatedNamespaces {
...
func (c *federatedNamespaces) Get(name string, options v1.GetOptions) (result *v1alpha1.FederatedNamespace, err error) {
	result = &v1alpha1.FederatedNamespace{}
	err = c.client.Get().
...
func (c *federatedNamespaces) List(opts v1.ListOptions) (result *v1alpha1.FederatedNamespaceList, err error) {
	result = &v1alpha1.FederatedNamespaceList{}
	err = c.client.Get().
		Resource("federatednamespaces").
...
func (c *federatedNamespaces) Create(federatedNamespace *v1alpha1.FederatedNamespace) (result *v1alpha1.FederatedNamespace, err error) {
	result = &v1alpha1.FederatedNamespace{}
	err = c.client.Post().
		Resource("federatednamespaces").
...
func (c *federatedNamespaces) Update(federatedNamespace *v1alpha1.FederatedNamespace) (result *v1alpha1.FederatedNamespace, err error) {
	result = &v1alpha1.FederatedNamespace{}
	err = c.client.Put().
		Resource("federatednamespaces").
...
func (c *federatedNamespaces) UpdateStatus(federatedNamespace *v1alpha1.FederatedNamespace) (result *v1alpha1.FederatedNamespace, err error) {
	result = &v1alpha1.FederatedNamespace{}
	err = c.client.Put().
		Resource("federatednamespaces").
		Name(federatedNamespace.Name).
...
func (c *federatedNamespaces) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.FederatedNamespace, err error) {
	result = &v1alpha1.FederatedNamespace{}
