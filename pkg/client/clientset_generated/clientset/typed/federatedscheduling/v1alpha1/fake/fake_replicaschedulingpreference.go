...
type FakeReplicaSchedulingPreferences struct {
	Fake *FakeFederatedschedulingV1alpha1
	ns   string
}

var replicaschedulingpreferencesResource = schema.GroupVersionResource{Group: "federatedscheduling.k8s.io", Version: "v1alpha1", Resource: "replicaschedulingpreferences"}

var replicaschedulingpreferencesKind = schema.GroupVersionKind{Group: "federatedscheduling.k8s.io", Version: "v1alpha1", Kind: "ReplicaSchedulingPreference"}
