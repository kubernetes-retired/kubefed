	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha1().FederatedDeploymentPlacements(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha1().FederatedDeploymentPlacements(namespace).Watch(options)
			},
		},
		&core_v1alpha1.FederatedDeploymentPlacement{},
		resyncPeriod,
		indexers,
	)
}

func (f *federatedDeploymentPlacementInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *federatedDeploymentPlacementInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&core_v1alpha1.FederatedDeploymentPlacement{}, f.defaultInformer)
}
