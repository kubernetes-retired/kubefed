...
type FederatedIngressInformer interface {
	...
	Lister() v1alpha1.FederatedIngressLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha1().FederatedIngresses(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha1().FederatedIngresses(namespace).Watch(options)
			},
		},
		&core_v1alpha1.FederatedIngress{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *federatedIngressInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&core_v1alpha1.FederatedIngress{}, f.defaultInformer)
}

func (f *federatedIngressInformer) Lister() v1alpha1.FederatedIngressLister {
	return v1alpha1.NewFederatedIngressLister(f.Informer().GetIndexer())
}
