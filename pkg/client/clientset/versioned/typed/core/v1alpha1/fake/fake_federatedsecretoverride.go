...
var federatedsecretoverridesResource = schema.GroupVersionResource{Group: "core.federation.k8s.io", Version: "v1alpha1", Resource: "federatedsecretoverrides"}

var federatedsecretoverridesKind = schema.GroupVersionKind{Group: "core.federation.k8s.io", Version: "v1alpha1", Kind: "FederatedSecretOverride"}
