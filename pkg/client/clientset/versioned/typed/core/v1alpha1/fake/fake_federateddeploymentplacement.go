...
var federateddeploymentplacementsResource = schema.GroupVersionResource{Group: "core.federation.k8s.io", Version: "v1alpha1", Resource: "federateddeploymentplacements"}

var federateddeploymentplacementsKind = schema.GroupVersionKind{Group: "core.federation.k8s.io", Version: "v1alpha1", Kind: "FederatedDeploymentPlacement"}
