...
var federatedreplicasetoverridesResource = schema.GroupVersionResource{Group: "core.federation.k8s.io", Version: "v1alpha1", Resource: "federatedreplicasetoverrides"}

var federatedreplicasetoverridesKind = schema.GroupVersionKind{Group: "core.federation.k8s.io", Version: "v1alpha1", Kind: "FederatedReplicaSetOverride"}
