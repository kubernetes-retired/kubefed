...
var federateddeploymentoverridesResource = schema.GroupVersionResource{Group: "core.federation.k8s.io", Version: "v1alpha1", Resource: "federateddeploymentoverrides"}

var federateddeploymentoverridesKind = schema.GroupVersionKind{Group: "core.federation.k8s.io", Version: "v1alpha1", Kind: "FederatedDeploymentOverride"}
