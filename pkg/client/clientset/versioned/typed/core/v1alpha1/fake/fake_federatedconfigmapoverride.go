...
var federatedconfigmapoverridesResource = schema.GroupVersionResource{Group: "core.federation.k8s.io", Version: "v1alpha1", Resource: "federatedconfigmapoverrides"}

var federatedconfigmapoverridesKind = schema.GroupVersionKind{Group: "core.federation.k8s.io", Version: "v1alpha1", Kind: "FederatedConfigMapOverride"}
