...
var federatedconfigmapplacementsResource = schema.GroupVersionResource{Group: "core.federation.k8s.io", Version: "v1alpha1", Resource: "federatedconfigmapplacements"}

var federatedconfigmapplacementsKind = schema.GroupVersionKind{Group: "core.federation.k8s.io", Version: "v1alpha1", Kind: "FederatedConfigMapPlacement"}
