...
type FederatedServicePlacementLister interface {
	...
	List(selector labels.Selector) (ret []*federation.FederatedServicePlacement, err error)
...
// List lists all FederatedServicePlacements in the indexer.
func (s *federatedServicePlacementLister) List(selector labels.Selector) (ret []*federation.FederatedServicePlacement, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*federation.FederatedServicePlacement))
	})
	return ret, err
}
...
type FederatedServicePlacementNamespaceLister interface {
	...
	Get(name string) (*federation.FederatedServicePlacement, error)
...
// List lists all FederatedServicePlacements in the indexer for a given namespace.
func (s federatedServicePlacementNamespaceLister) List(selector labels.Selector) (ret []*federation.FederatedServicePlacement, err error) {
...
// Get retrieves the FederatedServicePlacement from the indexer for a given namespace and name.
func (s federatedServicePlacementNamespaceLister) Get(name string) (*federation.FederatedServicePlacement, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(federation.Resource("federatedserviceplacement"), name)
	}
	return obj.(*federation.FederatedServicePlacement), nil
}
