...
type MultiClusterServiceDNSRecordLister interface {
	...
	List(selector labels.Selector) (ret []*multiclusterdns.MultiClusterServiceDNSRecord, err error)
...
// List lists all MultiClusterServiceDNSRecords in the indexer.
func (s *multiClusterServiceDNSRecordLister) List(selector labels.Selector) (ret []*multiclusterdns.MultiClusterServiceDNSRecord, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*multiclusterdns.MultiClusterServiceDNSRecord))
	})
	return ret, err
}
...
type MultiClusterServiceDNSRecordNamespaceLister interface {
	...
	Get(name string) (*multiclusterdns.MultiClusterServiceDNSRecord, error)
...
// List lists all MultiClusterServiceDNSRecords in the indexer for a given namespace.
func (s multiClusterServiceDNSRecordNamespaceLister) List(selector labels.Selector) (ret []*multiclusterdns.MultiClusterServiceDNSRecord, err error) {
...
// Get retrieves the MultiClusterServiceDNSRecord from the indexer for a given namespace and name.
func (s multiClusterServiceDNSRecordNamespaceLister) Get(name string) (*multiclusterdns.MultiClusterServiceDNSRecord, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(multiclusterdns.Resource("multiclusterservicednsrecord"), name)
	}
	return obj.(*multiclusterdns.MultiClusterServiceDNSRecord), nil
}
