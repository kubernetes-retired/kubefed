...
| global.scope                   | Whether the federation namespace will be the only target for federation. If set to `Namespaced`, the value set for `controllermanager.federationNamespace` will be ignored. | Cluster                                                                                              |
