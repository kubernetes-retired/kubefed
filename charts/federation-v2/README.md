...
| global.registryNamespace   | The cluster registry namespace.                                                                                                                                                                             | kube-multicluster-public                                                                              |
| controllermanager.limitedScope        | Whether the federation namespace will be the only target for federation. If set to true, the value set for `global.registryNamespace` and `global.registryNamespace` will be ignored. | false                                                                                                 |
